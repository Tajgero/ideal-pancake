...
class Game:
    def __init__(self):
        ...
        self.monster = self.player_monsters[0] # TODO
    ...
    def apply_attack(self, target, attack):
        ...
        animation = ABILITIES_DATA[attack]['animation']
        
        target.health -= attack_damage * attack_multiplier
        AttackAnimationSprite(target, self.attack_frames[animation], self.all_sprites)
